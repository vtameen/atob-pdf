...
2. Double-click the app once. macOS will say it *"could not verify AtoB PDF is free of malware"* - this is normal for an unsigned app. Click **Done** (NOT "Move to Trash").
3. Open **System Settings > Privacy & Security** and scroll down to the **Security** section. You will see *"AtoB PDF" was blocked to protect your Mac*.
4. Click **Open Anyway**, enter your Mac password, then click **Open** on the final prompt.
5. This approval is needed only once - afterwards the app opens like any other.

If the Settings entry does not appear, double-click the app again and go straight back to Privacy & Security. If macOS instead says the app is "damaged", run this in Terminal and try again: `xattr -cr "/Applications/AtoB PDF.app"`
